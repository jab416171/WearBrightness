...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    protected void updateView(View view) {
        ...
        try {
            ...
            mStatusText.setText(String.valueOf((int) (Double.valueOf(mCurrentValue) * 100.0 / 255)));
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        mStatusText.setText(String.valueOf((int) (Double.valueOf(value) * 100.0 / 255)));
        try {
...
//        }
        if (restoreValue) {
            try {
                ...
                Log.v(TAG, String.valueOf(mCurrentValue), e);
            }
        } else {
            int temp = 0;
            try {
